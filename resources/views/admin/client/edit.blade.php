                   ...
                   <div class="card">
                       <div class="card-body">
                           <div class="">
                               ...
                               <a  href="{{ route('client_create') }}" class="btn btn-primary waves-effect waves-light">Create</a>
                           </div>
                                            ...
                                            <div class="modal-body">
                                                <div class="text-center mb-4">
                                                    <div class="image-choose position-relative">
                                                        <img src="{{ asset('/storage/images/profile/'.$client->user->image) }}"
                                                        ...
                                                        <div class="avatar-xs position-absolute bottom-0 end-0">
                                                            <span class="avatar-title rounded-circle bg-light text-body">
                                                                <label>
                                                                 ...
                                                                 <input type="file" name="image" style="display:none" value="{{ $client->user->image }}">
                                                               </label>
                                                            </span>
                                                        </div>
                                                    </div>@extends('layout-admin.mainlayout')
                                                    @section('content')
                                                    <div class="page-content">
                                                        <div class="container-fluid">
                                                            <!-- start page title -->
                                                                                        ...
                                                                                        @method('POST')
                                                                                            ...
                                                                                            <div class="modal-body">
                                                                                                ...
                                                                                                <div class="row">
                                                                                                    <div class="col-xl-6">
                                                                                                        <div class="mb-3">
                                                                                                            ...
                                                                                                            <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Maestros" value="{{ $client->user->first_name }}" required="required">
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    ...
                                                                                                    <div class="col-xl-6">
                                                                                                        <div class="mb-3">
                                                                                                            ...
                                                                                                            <input type="text" class="form-control" name="last_name" id="last_name" placeholder="Roslyn" value="{{ $client->user->last_name }}" required="required">
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <!-- end row -->
                                                                                                <div class="mb-3">
                                                                                                    ...
                                                                                                    <input type="email" class="form-control" name="email" id="email" placeholder="roslyn.maestros@gmail.com" value="{{ $client->user->email }}" required="required" readonly="readonly">
                                                                                                </div>
