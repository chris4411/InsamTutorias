                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center my-5">
                                ...
                                <h3 class=" mt-4"><span class="fw-bold">Oops !</span> Cette page n'existe pas ou a ete
                                    recement deplacee !</h3>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center my-5">
                                    ...
                                    <!-- <h2 class="mt-4 fw-bold">Oops !</h2> -->
                                    <h3 class=" mt-4"><span class="fw-bold">Oops !</span> Cette page n'existe pas ou a ete recement deplacee !</h3>
                                    <div class="mt-4 text-center">
                                        <a class="btn btn-info waves-effect waves-light" href="{{ route('login') }}"><i
                                                class="mdi mdi-home-outline font-size-16 me-1"></i>Retourner a la connexion</a>
                                    </div>
