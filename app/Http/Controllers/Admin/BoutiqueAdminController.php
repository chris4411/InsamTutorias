...
class BoutiqueAdminController extends Controller
{
    ...
    {
        $view_data = ['boutiques'=> Boutique::with(['vendeur'])->get()];
        return view('admin.boutique.index', ['data'=>$view_data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        // $request->validate([
        //     'addresse_boutique' => 'required|max:8',
        //     'nom_boutique' => 'required|usersunique:|max:100',
        // ]);
